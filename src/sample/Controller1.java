...
public class Controller1 implements Initializable {
    ...
    @FXML
    private TextField city, contact, id_steam, name1, name2, nick, password1, password2;
    ...
    private void handleButtonAction(ActionEvent event) throws IOException, SQLException {
        ...
        if (b.equals(back)) {
            ...
            if (x) {
                ...
                Players p = new Players(date, city.getText(), contact.getText(), id_steam.getText(), name, nick.getText(), password);
    ...
    public boolean checkProfile() {
        ...
        if (born.getValue() != null && !city.getText().equals("") && !contact.getText().equals("") && !id_steam.getText().equals("") && !name1.getText().equals("") && !name2.getText().equals("") && !nick.getText().equals("") && !password1.getText().equals("") && !password2.getText().equals("")) {

            if (password1.getText().equals(password2.getText())) {

                String name = name1.getText() + " " + name2.getText();
                String numbers = city.getText() + contact.getText() + name + nick.getText();
