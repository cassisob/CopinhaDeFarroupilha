...
public class Dao_Teams {

    public void add(Players p) throws SQLException{
        String sql = SQL_Constantes.INSERT2;
    ...
    public List<String> searchall() throws SQLException{
        ...
        try (Connection connection = Conex.getConnection();
             PreparedStatement stmt = connection.prepareStatement(SQL_Constantes.SEARCH2);
    ...
    public void modify(Players p) throws SQLException{
        String sql = SQL_Constantes.UPDATE2;
    ...
    public void remove(String nome) throws SQLException{
        try (Connection connection = Conex.getConnection();
             PreparedStatement stmt = connection.prepareStatement(SQL_Constantes.REMOVE2)){
